...
@section('contenido')
        <div class="flex justify-center">
                ...
                <form action="{{route('productos.update', $producto)}}" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- Categoria --}}
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="descripcion" placeholder="Escriba la descripción" class="input input-bordered" maxlength="255" 
            value="{{$producto->descripcion}}" />
                    ...
                    <div class="form-control mt-6"><button class="btn btn-primary">Actualizar Producto</button><a href="{{ route('productos.index') }}" class="btn btn-outline btn-primary mt-4">Cancelar</a>
                    </div>
                </form>
                </div>
            </div>
